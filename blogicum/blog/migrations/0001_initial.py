...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'местоположенsие',
                'verbose_name_plural': 'Местополоaжения',
                'ordering': ('created_at',),
                'abstract': False,
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если установить датasdу и время в будущем — можно делать отложенные публикации.', verbose_name='Дата и времяss публикации')),
